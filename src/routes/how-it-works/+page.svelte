	...
	<div class="py-4 mx-auto max-w-7xl md:px-6">
		<div class="relative">
			<div class="bg-[#0A0A0B] relative sm:max-w-[50%] rounded-t-xl px-12 pt-16 pb-32 z-[1]">
				...
				<p class="text-3xl font-medium leading-[46px] sm:max-w-4xl">
			...
			<svg class="absolute bottom-0 right-0 z-0" xmlns="http://www.w3.org/2000/svg" width="738" height="389" fill="none">
				<g clip-path="url(#clip0_44_279)">
					...
					<g clip-path="url(#clip1_44_279)">
						<mask id="mask0_44_279" width="507" height="507" x="1" y="10" maskUnits="userSpaceOnUse" style="mask-type:alpha">
							<g stroke="#fff" stroke-width="1.319" clip-path="url(#clip2_44_279)">
								<path d="M1.655 389.202h506M1.655 325.892h506M1.655 262.581l506 .001M1.655 199.271h506M1.655 135.961h506M1.655 72.651h506"/>
							</g>
						</mask>
						<g mask="url(#mask0_44_279)">
							<mask id="mask1_44_279" width="508" height="507" x="1" y="10" maskUnits="userSpaceOnUse" style="mask-type:luminance">
								<rect width="506.483" height="506.483" x="1.655" y="516.483" fill="url(#paint0_radial_44_279)" rx=".013" transform="rotate(-90 1.655 516.483)"/>
							</mask>
							<g mask="url(#mask1_44_279)">
								<path fill="#131416" fill-opacity=".32" d="M1.655 516.483V10h506.483v506.483z"/>
							</g>
						</g>
						<g clip-path="url(#clip3_44_279)">
							<mask id="mask2_44_279" width="401" height="255" x="79" y="71" maskUnits="userSpaceOnUse" style="mask-type:luminance">
								<rect width="254.56" height="400.862" fill="url(#paint1_linear_44_279)" rx=".013" transform="matrix(0 -1 -1 0 480 326)"/>
							</mask>
							<g mask="url(#mask2_44_279)">
								<path fill="#765BFF" d="M480 326V71.44H79.138V326z"/>
							</g>
						</g>
						<g clip-path="url(#clip4_44_279)">
							<mask id="mask3_44_279" width="334" height="254" x="79" y="8" maskUnits="userSpaceOnUse" style="mask-type:luminance">
								<rect width="253.56" height="333.552" fill="url(#paint2_linear_44_279)" rx=".013" transform="matrix(0 -1 -1 0 413 262)"/>
							</mask>
							<g mask="url(#mask3_44_279)">
								<path fill="#131416" fill-opacity=".04" d="M413 262V8.44H79.448V262z"/>
							</g>
						</g>
						<mask id="mask4_44_279" width="476" height="274" x="66" y="116" maskUnits="userSpaceOnUse" style="mask-type:luminance">
							<rect width="475.862" height="273.026" fill="url(#paint3_linear_44_279)" rx=".013" transform="matrix(-1 0 0 1 542 116.043)"/>
						</mask>
						<g mask="url(#mask4_44_279)">
							<path fill="#FC6432" d="M531.448 135.828c5.828 0 10.552 4.724 10.552 10.551v233.457c0 5.828-4.724 10.552-10.552 10.552H76.69c-5.828 0-10.552-4.724-10.552-10.552V146.379c0-5.827 4.724-10.551 10.552-10.551h454.758Z"/>
						</g>
					</g>
				</g>
				<defs>
					<clipPath id="clip0_44_279">
						<path fill="#fff" d="M0 0h738v389H0z"/>
					</clipPath>
					<clipPath id="clip1_44_279">
						<path fill="#fff" d="M582-24.345v443.172H-30V-24.345z"/>
					</clipPath>
					<clipPath id="clip2_44_279">
						<path fill="#fff" d="M1.655 516.483v-506h506v506z"/>
					</clipPath>
					<clipPath id="clip3_44_279">
						<rect width="255" height="401" fill="#fff" rx="21.103" transform="matrix(0 -1 -1 0 480 326)"/>
					</clipPath>
					<clipPath id="clip4_44_279">
						<rect width="254" height="334" fill="#fff" rx="21.103" transform="matrix(0 -1 -1 0 413 262)"/>
					</clipPath>
					<linearGradient id="paint1_linear_44_279" x1="-125.241" x2="275.044" y1="-102.162" y2="274.658" gradientUnits="userSpaceOnUse">
						<stop offset=".25" stop-color="#fff"/>
						<stop offset=".309" stop-color="#FDFDFD"/>
						<stop offset=".357" stop-color="#F7F7F7"/>
						<stop offset=".396" stop-color="#EDEDED"/>
						<stop offset=".427" stop-color="#E0E0E0"/>
						<stop offset=".452" stop-color="#D1D1D1"/>
						<stop offset=".473" stop-color="#BFBFBF"/>
						<stop offset=".491" stop-color="#ABABAB"/>
						<stop offset=".509" stop-color="#969696"/>
						<stop offset=".527" stop-color="gray"/>
						<stop offset=".548" stop-color="#6A6A6A"/>
						<stop offset=".573" stop-color="#535353"/>
						<stop offset=".604" stop-color="#3D3D3D"/>
						<stop offset=".643" stop-color="#272727"/>
						<stop offset=".691" stop-color="#131313"/>
						<stop offset=".75" stop-color="#080808"/>
					</linearGradient>
					<linearGradient id="paint2_linear_44_279" x1="126.78" x2="126.78" y1="0" y2="333.552" gradientUnits="userSpaceOnUse">
						<stop offset=".167" stop-color="#D6D6D6"/>
						<stop offset=".229" stop-color="#D5D5D5"/>
						<stop offset=".284" stop-color="#D1D1D1"/>
						<stop offset=".332" stop-color="#CBCBCB"/>
						<stop offset=".375" stop-color="#C3C3C3"/>
						<stop offset=".414" stop-color="#B9B9B9"/>
						<stop offset=".449" stop-color="#AEAEAE"/>
						<stop offset=".483" stop-color="#A1A1A1"/>
						<stop offset=".517" stop-color="#929292"/>
						<stop offset=".551" stop-color="#838383"/>
						<stop offset=".586" stop-color="#727272"/>
						<stop offset=".625" stop-color="#606060"/>
						<stop offset=".668" stop-color="#4E4E4E"/>
						<stop offset=".716" stop-color="#3B3B3B"/>
						<stop offset=".771" stop-color="#282828"/>
						<stop offset=".833" stop-color="#151515"/>
					</linearGradient>
					<linearGradient id="paint3_linear_44_279" x1="31.394" x2="404.224" y1="273.026" y2="-60.336" gradientUnits="userSpaceOnUse">
						<stop stop-color="#fff"/>
						<stop offset="1"/>
					</linearGradient>
					<radialGradient id="paint0_radial_44_279" cx="0" cy="0" r="1" gradientTransform="rotate(90 -257.414 512.31) scale(253.241)" gradientUnits="userSpaceOnUse">
