...
export const config: { [key: string]: Config } = {
        ...
        VITE_HEADER_LINKS: [
            {name: '/voting', href: '/', display: 'Voting', target:'_self',
                items: [
                    ...
                    {name: '/bdp001-sip-021-nakamoto', href: '/dao/proposals/SP3JP0N1ZXGASRJ0F7QAHWFPGTVK9T2XNXDB908Z.bdp001-sip-021-nakamoto/results?method=1', display: 'SIP 021 Nakamoto Upgrade', target:'_self'},
                ]
            },
    ...
    "testnet": {
        ...
        VITE_SBTC_COORDINATOR: 'ST1R1061ZT6KPJXQ7PAXPFB6ZAZ6ZWW28G8HXK9G5',
        VITE_SBTC_CONTRACT_ID: 'ST1R1061ZT6KPJXQ7PAXPFB6ZAZ6ZWW28G8HXK9G5.asset-3',
        VITE_BRIDGE_API: 'https://api.testnet.stx.eco/bridge-api/v1',
        VITE_STACKS_API_HIRO: 'https://api.testnet.hiro.so',
        VITE_STACKS_API_HIRO_WS: 'wss://api.testnet.hiro.so',
        VITE_STACKS_API: 'https://api.testnet.hiro.so',
        VITE_STACKS_WS: 'ws://api.testnet.hiro.so',
    ...
    "mainnet": {
        ...
        VITE_BRIDGE_API: 'https://api.stx.eco/bridge-api/v1',
