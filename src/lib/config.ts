const SHARED_DEVENV_CONFIG = {
    ...
    VITE_DOA_PROPOSAL: 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.edp001-noop-sip-testnet',
    VITE_DOA_VOTING_EXTENSION: 'ede007-snapshot-proposal-voting-v2',
    ...
    VITE_DOA_FUNDED_SUBMISSION_EXTENSION: 'ede008-funded-proposal-submission-v5',
...
const TESTNET_CONFIG = {
    ...
    VITE_DOA_PROPOSAL: 'ST1NXBK3K5YYMD6FD41MVNP3JS1GABZ8TRVX023PT.gentle-turquoise-sparrow',
    VITE_DOA_VOTING_EXTENSION: 'ede007-snapshot-proposal-voting-v2',
    VITE_DOA_SNAPSHOT_VOTING_EXTENSION: 'ede007-snapshot-proposal-voting-v2',
    VITE_DOA_PROPOSAL_VOTING_EXTENSION: 'ede001-proposal-voting',
    VITE_DOA_FUNDED_SUBMISSION_EXTENSION: 'ede008-funded-proposal-submission-v2',
    VITE_DOA_EMERGENCY_EXECUTE_EXTENSION: 'ede004-emergency-execute',
...
const MAINNET_CONFIG = {
    ...
    VITE_DOA_PROPOSAL: 'SP3JP0N1ZXGASRJ0F7QAHWFPGTVK9T2XNXDB908Z.gentle-turquoise-sparrow',
