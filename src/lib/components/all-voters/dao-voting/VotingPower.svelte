  ...
  <div class="flex flex-col gap-y-4">
    <div class="w-full flex flex-col justify-start">
      <div class="rounded-lg pb-6 space-y-3">
        <Banner bannerType={'warning'} message={'Snapshot balance (connected wallet) when voting began, (at block ' + FormatUtils.fmtNumber(proposal.proposalData?.startBlockHeight) + '), was ' + balanceAtHeight + ' STX'} />
      </div>
    </div>
    {#if errorMessage}
