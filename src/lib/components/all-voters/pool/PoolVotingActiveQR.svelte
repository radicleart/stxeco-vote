...
<div>
  ...
  <div class="text-sm mb-4">Total voting power: {ChainUtils.fromMicroAmount(totalBalanceAtHeight)} STX (of which locked: {ChainUtils.fromMicroAmount(lockedBalanceAtHeight)})</div>
  {/if}
