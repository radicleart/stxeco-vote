						...
						<div>
							<div class="flex flex-col gap-y-4">
								<div class="flex flex-col">
									...
									<div
										class="w-full flex flex-col gap-y-4 justify-start border border-gray-700 rounded-lg my-4 p-3"
									>
										{#each roles as role}
											{#if role.deployed}
												<div class="flex flex-col gap-y-4">
													...
													{#if !role.constructed}
														<div>
															<button
																...
																class="justify-center w-[150px] md:inline-flex items-center gap-x-1.5 bg-success-01 px-4 py-2 rounded-xl border border-black bg-black text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500/50"
															>
																START DAO
															</button>
														</div>
								...
								{:else}
									...
									<div class="bottom-1 pb-5 mb-5 w-full flex flex-col justify-start">
										...
										<input
											id="project-name"
											class="rounded-lg p-2 text-black border-gray-800"
