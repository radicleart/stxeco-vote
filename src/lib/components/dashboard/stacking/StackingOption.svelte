...
<script lang="ts">
	...
	const openStackingOption = () => {
		goto(option.action)
	}

</script>

<a href="/" on:click|preventDefault={() => openStackingOption()} class="group flex flex-col overflow-hidden border border-transparent hover:border-[#FC6432] rounded-lg relative bg-[#E6E4E2] px-6 py-6 transition duration-300 ease-in-out">
