...
<div class="h-full flex flex-col items-stretch min-h-[200px]">
	...
	<div class="h-full text-sm flex flex-col flex-0 z-[1]">
		<div class="">
			<h4 class="text-lg mt-0 text-[#131416] mb-3">Signer slots</h4>
			<p class="text-sm mt-0 text-[#131416] mb-3">Set by the stacks node</p>
		</div>

		{#if signerSlots}
		<SignerSlotsSection slots={signerSlots.page0} page={0}/>
		<SignerSlotsSection slots={signerSlots.page1} page={1} />
		{/if}
	</div>
